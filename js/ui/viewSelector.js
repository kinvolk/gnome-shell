...
const ViewsDisplayLayout = new Lang.Class({
    ...
    vfunc_get_preferred_height: function(container, forWidth) {
        log("ViewsDisplayLayout:: vfunc_get_preferred_height(" + forWidth + ")")
    ...
    vfunc_allocate: function(container, box, flags) {
        ...
        // let height = this._appDisplayActor.get_preferred_height(availHeight)[1];
        // // height = this._appDisplayActor.get_preferred_height(999)[1];
